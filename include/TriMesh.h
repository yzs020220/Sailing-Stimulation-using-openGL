...
public:
	...
	void shark_movement(float speed);
	void changeDir(float dir);
	void shake(float offset);
	...
	void readObjMtl(const std::string& objFile, const std::string& mtlFile);
...
public:
	Light() { constant = 0; linear = 0; quadratic = 0; }
